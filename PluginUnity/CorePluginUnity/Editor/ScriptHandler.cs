...
//		{
//			selectedFile = EditorUtility.OpenFilePanel ("Select a script to load", "Documents", Constants.iaFileExtension);
//			if (selectedFile != "")
//			{
...
//		GUILayout.Label (selectedFile, EditorStyles.boldLabel);
//		GUILayout.Button (new GUIContent(EditorGUIUtility.IconContent("Toolbar Plus")));